...
val create : Lwt_unix.file_descr option -> int64 -> Lwt_mutex.t -> Mirage_block.info -> Config.t -> bool -> t

val get_elems : t -> Lwt_unix.file_descr option * int64 * Lwt_mutex.t * Mirage_block.info * Config.t * bool 
...
val of_fd: string -> Unix.file_descr -> t Lwt.t
