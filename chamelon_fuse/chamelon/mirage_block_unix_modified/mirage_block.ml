...
module type S = sig
  ...
  val create : Lwt_unix.file_descr option -> int64 -> Lwt_mutex.t -> info -> Config.t -> bool -> t
  val get_elems : t -> Lwt_unix.file_descr option * int64 * Lwt_mutex.t * info * Config.t * bool 
